...
| --------------- | ------------ | ----------------------------------------------------------------------------------------------------- |
| relayer-api-key | primary key  | api key received from onboarding api                                                                  |
| signature       | varchar      | the request signature can be generate from request parameters and signed with your relayer-api-secret |
| timestamp       | datetime     | unix formated datetime                                                                                |
