-- Revert orderbook view to original definition (without REMOVE_CLOSE_LIMIT_PRICE handling)

-- 1. Drop the expanded partial index
...
-- 3. Restore original partial index (without REMOVE)
